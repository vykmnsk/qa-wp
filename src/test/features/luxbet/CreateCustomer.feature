...
Feature: Create Luxbet Customer
  ...
  Scenario Outline: Create Luxbet South Australian Customer on UI
    When I navigate to insert new customer page
    And I enter specifics to create new customer through wagerplayer
      | title                      | "<title>"                      |
      | firstname                  | "<firstname>"                  |
      | lastname                   | "<lastname>"                   |
    ...
    And I see AML status updated to "Account Verified" or "Active - KYC verified"
