...
#  Scenario Outline: Horse Race Exotic Running Double bets
#    When I enter specifics category "Horse Racing" and subcategory "WOLVERHAMPTON"
#    And I create a default event with details
#      | base name | TEST RACE                                                                      |
#      | runners   | Runner01, Runner02, Runner03, Runner04, Runner05, Runner06, Runner07, Runner08 |
...
#    Examples:
#      | ProductName        | BetType | BetOn             | Stake | Flexi | BalanceDeductedBy | Payout |
#      | NSW Running Double | Exacta  | Runner01,Runner02 | 3.00  |       | 6.00              | 1.50   |
...
#      | base name | TEST RACE                                                                      |
#      | runners   | Runner01, Runner02, Runner03, Runner04, Runner05, Runner06, Runner07, Runner08 |
#      | prices    | 1.30, 2.60, 1.40, 2.80, 1.50, 3.00, 1.60, 3.20                                 |
#    And I enable "Luxbook DVP Fixed" product settings
#      | Betting | Enabled       | On    |
#      | Betting | Enable Single | Win   |
#      | Betting | Enable Single | Place |
...
#      | base name | TEST RACE                                                                      |
#      | runners   | Runner01, Runner02, Runner03, Runner04, Runner05, Runner06, Runner07, Runner08 |
#      | prices    | 1.40, 2.80, 1.50, 3.00, 1.60, 3.20, 1.70, 3.40                                 |
#    And I enable "Luxbook DVP Fixed" product settings
#      | Betting | Enabled       | On    |
#      | Betting | Enable Single | Win   |
#      | Betting | Enable Single | Place |
...
#    Examples:
#      | ProductName | BetType  | BetOn                      | Stake | Flexi | BalanceDeductedBy | Payout |
#      | NSW Quaddie | Trifecta | Runner01,Runner02,Runner03 | 3.00  |       | 18.00             | 1.50   |