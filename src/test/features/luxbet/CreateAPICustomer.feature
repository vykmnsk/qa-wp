...
Feature: Create Luxbet API Customer
  ...
  Scenario Outline: Create Luxbet Customer using API
    ...
    Examples:
      | title | firstname | lastname | date_of_birth | phonenumber | email_address      | streetaddress    | suburb         | state | postcode | country | weekly_deposit_limit | clientip    | username          | telephone_password | internet_password   | security_question       | customer_answer   | currency | timezone         |
      ...
      | Ms    | Keli      | Cowey    | 1952-03-25    | 0463254781  | random@example.com | 13aAlan Ave      | SEAFORTH       | NSW   | 2092     | AU      |                      | 61.9.192.13 | #RANDOM_USERNAME# | #TELE_PASSWORD#    | #INTERNET_PASSWORD# | Favourite Holiday Spot? | #CHALLENGEANSWER# | AUD      | Australia/Sydney |