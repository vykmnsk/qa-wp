...
Feature: Create Luxbet API Customer
  ...
  Scenario Outline: Create Luxbet Customer using API
    ...
    Examples:
      ...
      | Mr    | Oswald    | Petrucco | 1939-05-31    | 0421147741  | random@example.com | 142 Tynte Street | North Adelaide | SA    | 5006     | AU      | 4500.00              | 61.9.192.13 | Favourite Holiday Spot? | Australia       | AUD      | Australia/Sydney |
      | Ms    | Keli      | Cowey    | 1952-03-25    | 0463254781  | random@example.com | 13aAlan Ave      | SEAFORTH       | NSW   | 2092     | AU      |                      | 61.9.192.13 | Favourite Holiday Spot? | Australia       | AUD      | Australia/Sydney |