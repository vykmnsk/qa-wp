...
Feature: Placing and Settling multi Bets
  ...
  Scenario Outline: Racing Multi Double bets
    ...
    When I place a Luxbet Multi Bet Double "<BetType1>"-"<BetType2>" on the runners "<BetOn>" for $<Stake> with flexi as "<Flexi>"
  ...
  @smoke
    Examples:
      | Category1    | Subcategory1 | Category2    | Subcategory2 | BetType1 | BetType2 | BetOn             | Stake | Flexi | Deduction | Payout |
  ...
  Scenario Outline: Racing Multi Treble/Doubles/Trixie/Patent bets
    ...
    Examples:
      | Category1        | Subcategory1 | Category2        | Subcategory2 | MultiType | BetOn                      | Stake | Flexi | Deduction | Payout  |
